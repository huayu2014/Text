...
//    [self addSubview:mView];
    ...
    label1.text=@"我是第二个View哦";
    [View1 addSubview:label1];
    
    UIButton *btn=[UIButton buttonWithType:UIButtonTypeRoundedRect];
    btn.frame=CGRectMake(10, 200, 500, 60);
    [btn setTitle:@"点击跳转到第三个View里面。。。" forState:UIControlStateNormal];
...
-(void)btnClcik
{
    mUIView3 =[[UIView3 alloc]initWithFrame:self.bounds];
    [self addSubview:mUIView3];
